...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx99a1e44659e5361e',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'be980625ac2bfdf66f5ac4c12cbdbdf6',
   ...
   */
  USERS: [oMEud50qAt8250i_24VhaLK8JGSs]
    {
      // 想要发送的人的名字
      name: '小可爱',
      ...
      id: '',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'dciP1jUtU0nYx3M63btkvNrxpAkLHFDBmN9aapD8JtA',
      // 所在省份
      province: '天津',
      // 所在城市
      city: '天津',
  ...
  */
  ...
  CALLBACK_TEMPLATE_ID: 'dciP1jUtU0nYx3M63btkvNrxpAkLHFDBmN9aapD8JtA',
